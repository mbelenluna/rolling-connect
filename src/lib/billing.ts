...
export { isSpanish, clientChargeCents, clientChargeCentsWithRates, interpreterPayCents, interpreterPayCentsWithRates, formatCents, CLIENT_PRICING_TABLE } from './billing-rates';
