...
async function main() {
  ...
  // Languages (no duplicates; existing: en, es, zh, ar, vi, ko, ru, fr)
  const languages = [
    ...
    { code: 'nan', name: 'Fukienese' },
    { code: 'zh-fuz', name: 'Fuzhou' },
    { code: 'de', name: 'German' },
    { code: 'el', name: 'Greek' },
